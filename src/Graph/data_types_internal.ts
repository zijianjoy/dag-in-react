...
export type Without<T, U> = {
  ...
  /**
   * Icon information needed to render an icon with Ace-Icons
   *
   * - `iconset`: Defaults to `common`
   * - `color`: Defaults to `currentColor`
   * - `size`: Defaults are in
   * `//google3/cloud/console/web/common/components/ai/visualization/directed_acyclic_graph/icons_module.ts`
   */
